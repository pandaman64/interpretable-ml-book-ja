...
-->
この本で使用する具体例のために、データは少し処理されています。データ処理のためのRのスクリプトは、[GitHubのリポジトリ](https://github.com/christophM/interpretable-ml-book/blob/master/R/get-bike-sharing-dataset.R)で取得できます。処理後のデータは、[ここ ](https://github.com/christophM/interpretable-ml-book/blob/master/data/bike.RData)から取得できます。
...
[視聴率記録を更新した「Gangnam Style」の動画はこちら](https://www.youtube.com/watch?v=9bZkp7q19f0&feature=player_embedded).
...
-->
もしこのデータで遊びたいのならば、この本のGitHubレポジトリに [RDataファイル](https://github.com/christophM/interpretable-ml-book/blob/master/data/ycomments.RData) があります。また、便利な関数はここ[R-script](https://github.com/christophM/interpretable-ml-book/blob/master/R/get-SpamTube-dataset.R) にあります。
...
データは Fernandes, Cardoso, Fernandes(2017)[^Fernandes] によって作成されており、[UCI機械学習リポジトリ](https://archive.ics.uci.edu/ml/datasets/Cervical+cancer+%28Risk+Factors%29) からダウンロードできます。
...
前処理の[R-script](https://github.com/christophM/interpretable-ml-book/blob/master/R/get-cervical-cancer-dataset.R)と最終の[RDataファイル](https://github.com/christophM/interpretable-ml-book/blob/master/data/cervical.RData)
